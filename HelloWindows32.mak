...
!MESSAGE 
!MESSAGE NMAKE /f "HelloWindows32.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/HelloWindows32.exe $(OUTDIR)/HelloWindows32.bsc
...
CPP_PROJ=/nologo /ML /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"HelloWindows32.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
CPP_PROJ=/nologo /ML /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"HelloWindows32.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"HelloWindows32.pdb" /c 
CPP_OBJS=.\WinDebug/
